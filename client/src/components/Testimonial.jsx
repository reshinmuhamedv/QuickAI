...
const Testimonial = () => {
    const dummyTestimonialData = [
        {
            image: "/photo_2025-12-01_15-24-43.jpg",
            name: 'Pranav',
        ...
        {
            image: "/photo_2025-12-01_15-25-04.jpg",
            name: 'Vishnu',
        ...
        {
            image: "/photo_2025-12-01_15-38-04.jpg",
            name: 'Yaswanth',
                ...
                {dummyTestimonialData.map((testimonial, index) => (
                    <div key={index} className='p-8 m-4 max-w-xs rounded-lg bg-[#FDFDFE] shadow-lg border border-gray-100 hover:-translate-y-1 transition duration-300 cursor-pointer'>
                        <div className="flex items-center gap-1">
                            {Array(5).fill().map((_, i) => (<img key={i} src={i < testimonial.rating ? assets.star_icon : assets.star_dull_icon} />))}
                        </div>
