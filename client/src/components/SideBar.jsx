...
const navItems = [
    ...
    {to: '/ai/write-article', label: 'Article Writer', Icon: SquarePen},
...
const SideBar = ({sidebar, setSidebar}) => {
  ...
  return (
    <div className={`w-60 bg-white border-r border-gray-200 flex flex-col
         justify-between items-center max-sm:absolute top-14 bottom-0 ${sidebar ? 'translate-x-0' : 'max-sm:-translate-x-full'}
         transition-all duration-300 ease-in-out`}>
        
        <div className='my-7 w-full'>
            <img src={user.imageUrl} alt='yo pic' className='w-13 rounded-full mx-auto' />
        ...
        <div className='w-full border-gray-200 p-4 px-7 flex items-center justify-between'>
            <div onClick={openUserProfile} className='flex gap-2 items-center cursor-pointer'>
                <img src={user.imageUrl} className='w-8 rounded-full' alt='yo pic'></img>
                <div>
